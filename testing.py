...
# GUI Setup
root = tk.Tk()
root.title("Lingox - AI Translator & Summarizer")
...
summarize_btn = tk.Button(button_frame, text="AI Summarize", command=summarize_text, bg="#FF9800", fg="white", width=15)
summarize_btn.grid(row=0, column=2, padx=5, pady=5)

# Output Labels
tk.Label(root, text="Translated Text", font=("Arial", 12), bg="#f0f0f0").pack()
output_label = tk.Label(root, text="", wraplength=500, fg="blue", bg="white", height=5, width=60, relief="solid")
output_label.pack(pady=5)

tk.Label(root, text="AI Summarized Text", font=("Arial", 12), bg="#f0f0f0").pack()
summary_label = tk.Label(root, text="", wraplength=500, fg="green", bg="white", height=5, width=60, relief="solid")
